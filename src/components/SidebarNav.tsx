...
function getNavItems(role: string): NavItem[] {
  const items: Record<string, NavItem[]> = {
    admin: [
      ...
      { title: "Biometric Device", tab: "biometric-device", url: "/admin?tab=biometric-device", icon: Fingerprint },
      { title: "Payments", tab: "payments", url: "/admin?tab=payments", icon: CreditCard },
      { title: "Printable Billing", tab: "billing", url: "/admin?tab=billing", icon: Receipt },
